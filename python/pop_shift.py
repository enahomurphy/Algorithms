...
# a) remove the final character from the original string, add to solution string 1. b) remove 
# the first character from the original string, add to solution string 2.
...
popShift("exampletesthere") becomes: ["erehtse","example","t"]
